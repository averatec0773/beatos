...
const FIELDS: { key: "album_name" | "beat_name" | "beat_description"; label: string; rows: number }[] = [
  ...
  return (
    <section className="mb-10">
      ...
      <p className="text-xs text-text-tertiary mb-3">
        ...
        <code className="mx-1">{"{title} {genre} {year} {prod} {bpm} {key}"}</code>
      </p>
      <div className="space-y-3">
        ...
        <label className="block">
          <span className="text-sm text-text-secondary">制作人署名</span>
          <input
            aria-label="制作人署名"
